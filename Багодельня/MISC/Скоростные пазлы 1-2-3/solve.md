# Скоростные пазлы 1-2-3

## Overview

**Категория:** MISC  
**Описание:** Серия из трёх задач на сборку пазлов за 1 минуту.

### Задачи серии

1. **Пазл 1:** 16 кусочков (4×4)
2. **Пазл 2:** 64 кусочка (8×8)
3. **Пазл 3:** 256 кусочков (16×16)

Чтобы получить флаг, нужно успеть собрать весь пазл за 1 минуту в каждой задаче.
...
1. Открыть страницу с пазлом в браузере
2. Открыть консоль разработчика (F12)
3. Скопировать и выполнить скрипт
4. Дождаться автоматической сборки и отправки решения
5. Получить флаг
...
- Canvas API для работы с изображениями
